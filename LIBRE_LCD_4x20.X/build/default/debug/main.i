...
void Lcd_Out(int x, int y, char *mensaje);
void Lcd_Chr(int x, int y, char *mensaje);
...
void set_comando(int valor_comando){
     PORTDbits.RD7= (valor_comando & 0b00001000);
     PORTDbits.RD6= (valor_comando & 0b00000100);
     PORTDbits.RD5= (valor_comando & 0b00000010);
     PORTDbits.RD4= (valor_comando & 0b00000001);
}

void cargar_comando(){
    PORTDbits.RD1=1;
     _delay((unsigned long)((300)*(4000000L/4000000.0)));
    PORTDbits.RD1=0;
}
...
void Lcd_Init(){
    ...
    PORTDbits.RD4=PORTDbits.RD5=PORTDbits.RD6=PORTDbits.RD7=PORTDbits.RD1=PORTDbits.RD0=0;
    _delay((unsigned long)((15)*(4000000L/4000.0)));
    _delay((unsigned long)((2000)*(4000000L/4000000.0)));

    for(repeticiones=0; repeticiones <3; repeticiones++){
        set_comando(3);
        cargar_comando();
        _delay((unsigned long)((6)*(4000000L/4000.0)));
    }
    set_comando(2);
    cargar_comando();
    _delay((unsigned long)((6)*(4000000L/4000.0)));
