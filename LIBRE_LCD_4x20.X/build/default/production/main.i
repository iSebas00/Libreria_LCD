...
void set_valor(int valor_comando){
     PORTDbits.RD7= (valor_comando & 0b00001000)>>3;
     PORTDbits.RD6= (valor_comando & 0b00000100)>>2;
     PORTDbits.RD5= (valor_comando & 0b00000010)>>1;
...
void Lcd_Init(){
    ...
    TRISDbits.RD4=TRISDbits.RD5=TRISDbits.RD6=TRISDbits.RD7=TRISDbits.RD1=TRISDbits.RD0=0;

    PORTDbits.RD1=PORTDbits.RD0=PORTDbits.RD4=PORTDbits.RD5=PORTDbits.RD6=PORTDbits.RD7=0;
    _delay((unsigned long)((15)*(4000000L/4000.0)));


    set_valor(3);
    _delay((unsigned long)((4)*(4000000L/4000.0)));
    set_valor(3);
    set_valor(3);
    set_valor(3);
    set_valor(2);
